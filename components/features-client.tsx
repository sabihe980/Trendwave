...
export default function FeaturesClient() {
  ...
  const tonePresets = {
    ...
    professional: {
      text: "Announcing Postrick's unified content scheduling matrix. Re-engineer corporate distribution workflows, sequence multi-channel campaigns natively, and capture peak audience waves. Contact sales for custom team enterprise SLAs.",
    ...
    bold: {
      ...
      tags: "#BrandGrowth #MarketingSystems #Postrick",
      readTime: "9s read - 45 words"
    },
    friendly: {
      text: "Hey everyone! 👋 Planning your weekly socials shouldn't feel like a chore. That's why we built Postrick to easily format and drag-and-drop drafts across all channels safely. Let us know how it powers your workflow!",
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-2 cursor-pointer">
              ...
              <span className="font-serif font-black tracking-tight text-2xl italic text-[#02180c]">
                Postrick<span className="text-xs font-sans not-italic font-bold align-super">®</span>
              </span>
            </Link>
          ...
          <div className="lg:col-span-7 order-1 lg:order-2">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden bg-neutral-900 aspect-video flex items-center justify-center border group">
                <img 
                  src="https://picsum.photos/seed/autopub/800/450" 
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-inner border border-[#eae3d2]/60">
                <img 
                  src="https://picsum.photos/seed/calendar/800/450" 
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl border border-[#eae3d2] p-5 shadow-inner bg-white min-h-[160px] flex flex-col justify-between relative overflow-hidden">
                  ...
                  <div className="absolute right-0 bottom-0 opacity-[0.03] pointer-events-none w-48 h-48 select-none">
                    <img src="https://picsum.photos/seed/aicaption/150/150" alt="Watermark" className="w-full h-full object-cover rounded-full" />
                  </div>
            ...
            >
              ...
              <div className="grid grid-cols-12 gap-4">
                ...
                <div className="col-span-8 relative rounded-2xl overflow-hidden border border-[#eae3d2] shadow-sm aspect-video">
                  <img 
                    src="https://picsum.photos/seed/creative/800/450" 
                ...
                <div className="col-span-4 relative rounded-2xl overflow-hidden border border-[#eae3d2] shadow-sm aspect-[3/4]">
                  <img 
                    src="https://picsum.photos/seed/creativeportrait/400/533" 
                    alt="Story Crop" 
